#
#  Be sure to run `pod spec lint Pacific.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors            = { "Andrew Aquino" => "andrewaquino118@yahoo.com" }
  # s.social_media_url   = "http://twitter.com/Andrew Aquino"
